...
const ModalEliminarColaborador = () => {
    ...
    const { modalEliminarColaborador, setModalEliminarColaborador, eliminarColaborador, setColaborador } = useProyectos()
    return (
        <Transition.Root show={ modalEliminarColaborador } as={Fragment}>
            ...
            >
                <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    >
                            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg md:max-w-xl sm:w-full sm:p-6">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div className='mt-2'>
                                        <p className='text-gray-500'>
                                            No puedes deshacer los cambios
                                        </p>
                                    </div>
