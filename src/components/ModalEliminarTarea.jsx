...
const ModalEliminarTarea = () => {
    ...
    const { modalEliminarTarea, setModalEliminarTarea, eliminarTarea } = useProyectos()
    return (
        <Transition.Root show={ modalEliminarTarea } as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={() => setModalEliminarTarea(false)}>
                    ...
                    >
                            ...
                            <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                                <button
                                    ...
                                    onClick={() => setModalEliminarTarea(false)}
                                >
