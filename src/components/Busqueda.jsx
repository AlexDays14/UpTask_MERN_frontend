...
const Busqueda = () => {
    ...
    return (
        <Transition.Root show={buscador} as={Fragment} 
            afterLeave={() => {
                setBusqueda('')
            }}
        >
            <Dialog as="div" className="fixed inset-0 z-10 overflow-y-auto mt-20 p-4 sm:p-20 md:p-20" onClose={handleBuscador}>
                ...
                >
                    <div className="relative">
                        <Combobox.Input
                            className="w-full border-0 bg-transparent py-5 text-lg pl-11 pr-4 text-gray-800 placeholder-gray-400 focus:ring-0"
                            placeholder="Buscar..."
